...
<AccordionGroup>
  <Accordion icon="rectangle-terminal" title="Create account on vivgrid">
    Create account by logging in to our [dashboard](https://dashboard.vivgrid.com).
...
-d '{"model": "gpt-4o", "messages": [{"role": "user", "content": "how is the weather today in Paris and Tokyo?"}], "stream": true}'
```
